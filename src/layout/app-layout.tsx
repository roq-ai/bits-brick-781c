...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'contractor', 'equipment-owner'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Equipment', path: '/equipment', entity: 'equipment', service: AccessServiceEnum.PROJECT, icon: FiTruck },
